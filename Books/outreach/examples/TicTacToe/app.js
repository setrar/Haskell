...
var $author$project$TicTacToe$Tick = F2(
	function (a, b) {
		return {$: 'Tick', a: a, b: b};
	});
		...
		return $MacCASOutreach$graphicsvg$GraphicSVG$ellieApp(
			{
				...
				update: $MacCASOutreach$graphicsvg$GraphicSVG$EllieApp$hiddenGameUpdate(userUpdate),
				view: function (_v2) {
					var userModel = _v2.a;
					return {
						body: A2(
...
var $author$project$TicTacToe$EmptyBox = {$: 'EmptyBox'};
var $author$project$TicTacToe$Left = {$: 'Left'};
var $author$project$TicTacToe$init = {box11: $author$project$TicTacToe$EmptyBox, box12: $author$project$TicTacToe$EmptyBox, box13: $author$project$TicTacToe$EmptyBox, box21: $author$project$TicTacToe$EmptyBox, box22: $author$project$TicTacToe$EmptyBox, box23: $author$project$TicTacToe$EmptyBox, box31: $author$project$TicTacToe$EmptyBox, box32: $author$project$TicTacToe$EmptyBox, box33: $author$project$TicTacToe$EmptyBox, player: $author$project$TicTacToe$Left, time: 0};
var $author$project$TicTacToe$Click11 = {$: 'Click11'};
var $author$project$TicTacToe$Click12 = {$: 'Click12'};
var $author$project$TicTacToe$Click13 = {$: 'Click13'};
var $author$project$TicTacToe$Click21 = {$: 'Click21'};
var $author$project$TicTacToe$Click22 = {$: 'Click22'};
var $author$project$TicTacToe$Click23 = {$: 'Click23'};
var $author$project$TicTacToe$Click31 = {$: 'Click31'};
var $author$project$TicTacToe$Click32 = {$: 'Click32'};
var $author$project$TicTacToe$Click33 = {$: 'Click33'};
...
var $author$project$TicTacToe$boxColour = function (box) {
	switch (box.$) {
		case 'LeftBox':
			return A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 0, 0, 255);
		case 'RightBox':
			return A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 255, 0, 0);
		default:
			return A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 255, 0, 255);
	}
};
...
var $author$project$TicTacToe$playerBanner = function (player) {
	if (player.$ === 'Left') {
		return A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			$MacCASOutreach$graphicsvg$GraphicSVG$black,
			$MacCASOutreach$graphicsvg$GraphicSVG$centered(
				$MacCASOutreach$graphicsvg$GraphicSVG$text('Left Player')));
	} else {
		return A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			$MacCASOutreach$graphicsvg$GraphicSVG$black,
			$MacCASOutreach$graphicsvg$GraphicSVG$centered(
				$MacCASOutreach$graphicsvg$GraphicSVG$text('Right Player')));
	}
};
...
var $author$project$TicTacToe$victory = function (model) {
	return (_Utils_eq(model.box11, model.box12) && (_Utils_eq(model.box12, model.box13) && (!_Utils_eq(model.box11, $author$project$TicTacToe$EmptyBox)))) ? 'Somebody won!' : '';
};
var $MacCASOutreach$graphicsvg$GraphicSVG$yellow = A4($MacCASOutreach$graphicsvg$GraphicSVG$RGBA, 237, 212, 0, 1);
var $author$project$TicTacToe$myShapes = function (model) {
	return A3(
		$MacCASOutreach$graphicsvg$GraphicSVG$Collage,
		500,
		500,
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$TicTacToe$Click11,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box11),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(0, 12),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click12,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box12),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(12, 12),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click13,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box13),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(-12, 0),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click21,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box21),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(0, 0),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click22,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box22),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(12, 0),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click23,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box23),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(-12, -12),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click31,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box31),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(0, -12),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click32,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box32),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(12, -12),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
					$author$project$TicTacToe$Click33,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$author$project$TicTacToe$boxColour(model.box33),
						$MacCASOutreach$graphicsvg$GraphicSVG$square(10)))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(0, 50),
				$author$project$TicTacToe$playerBanner(model.player)),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(80, 50),
				A2(
					...
					$MacCASOutreach$graphicsvg$GraphicSVG$text(
						$elm$core$String$fromInt(
							$elm$core$Basics$round(model.time))))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				...
				$MacCASOutreach$graphicsvg$GraphicSVG$centered(
					A2(
						...
						30,
						$MacCASOutreach$graphicsvg$GraphicSVG$text(
							$author$project$TicTacToe$victory(model)))))
			]));
};
var $author$project$TicTacToe$LeftBox = {$: 'LeftBox'};
var $author$project$TicTacToe$RightBox = {$: 'RightBox'};
var $author$project$TicTacToe$changeBox = F2(
	function (player, box) {
		var _v0 = _Utils_Tuple2(player, box);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 'Left') {
				if (_v0.b.$ === 'EmptyBox') {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
					return $author$project$TicTacToe$LeftBox;
				} else {
					break _v0$2;
				}
			} else {
				if (_v0.b.$ === 'EmptyBox') {
					var _v3 = _v0.a;
					var _v4 = _v0.b;
					return $author$project$TicTacToe$RightBox;
				} else {
					break _v0$2;
				}
			}
...
var $author$project$TicTacToe$Right = {$: 'Right'};
var $author$project$TicTacToe$swapPlayer = function (player) {
	if (player.$ === 'Left') {
		...
		switch (msg.$) {
			...
			case 'Click11':
				return _Utils_update(
					model,
					{
						box11: A2($author$project$TicTacToe$changeBox, model.player, model.box11),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click12':
				return _Utils_update(
					model,
					{
						box12: A2($author$project$TicTacToe$changeBox, model.player, model.box12),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click13':
				return _Utils_update(
					model,
					{
						box13: A2($author$project$TicTacToe$changeBox, model.player, model.box13),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click21':
				return _Utils_update(
					model,
					{
						box21: A2($author$project$TicTacToe$changeBox, model.player, model.box21),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click22':
				return _Utils_update(
					model,
					{
						box22: A2($author$project$TicTacToe$changeBox, model.player, model.box22),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click23':
				return _Utils_update(
					model,
					{
						box23: A2($author$project$TicTacToe$changeBox, model.player, model.box23),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click31':
				return _Utils_update(
					model,
					{
						box31: A2($author$project$TicTacToe$changeBox, model.player, model.box31),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			case 'Click32':
				return _Utils_update(
					model,
					{
						box32: A2($author$project$TicTacToe$changeBox, model.player, model.box32),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
			default:
				return _Utils_update(
					model,
					{
						box33: A2($author$project$TicTacToe$changeBox, model.player, model.box33),
						player: $author$project$TicTacToe$swapPlayer(model.player)
					});
		}
	});
var $author$project$TicTacToe$main = A2(
	$MacCASOutreach$graphicsvg$GraphicSVG$EllieApp$gameApp,
	$author$project$TicTacToe$Tick,
	{model: $author$project$TicTacToe$init, title: 'Ellie Example', update: $author$project$TicTacToe$update, view: $author$project$TicTacToe$myShapes});
