...
var $author$project$TwoShips$Tick = F2(
	function (a, b) {
		return {$: 'Tick', a: a, b: b};
	});
...
var $author$project$TwoShips$init = {
	posL: _Utils_Tuple2(-20, 0),
	posR: _Utils_Tuple2(20, 0),
	time: 0,
	velL: _Utils_Tuple2(0, 0),
	velR: _Utils_Tuple2(0, 0)
};
...
var $author$project$TwoShips$drawShip = F3(
	function (clr, pos, _v0) {
		var vx = _v0.a;
		var vy = _v0.b;
		return A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$move,
...
var $author$project$TwoShips$myShapes = function (model) {
	return A3(
		$MacCASOutreach$graphicsvg$GraphicSVG$Collage,
		500,
		500,
		_List_fromArray(
			[
				A3(
				$author$project$TwoShips$drawShip,
...
var $author$project$TwoShips$s = 0.1;
var $author$project$TwoShips$timeStep = F2(
	function (_v0, _v1) {
		var changeX = _v0.a;
		var changeY = _v0.b;
		var x = _v1.a;
		var y = _v1.b;
		return _Utils_Tuple2(x + ($author$project$TwoShips$s * changeX), y + ($author$project$TwoShips$s * changeY));
	});
var $author$project$TwoShips$update = F2(
	function (msg, model) {
		var t = msg.a;
		var _v1 = msg.b;
		var accelR = _v1.b;
		...
		return _Utils_update(
			model,
			{
				posL: A2($author$project$TwoShips$timeStep, model.velL, model.posL),
				posR: A2($author$project$TwoShips$timeStep, model.velR, model.posR),
				time: t,
				velL: A2($author$project$TwoShips$timeStep, accelL, model.velL),
				velR: A2($author$project$TwoShips$timeStep, accelR, model.velR)
			});
	});
var $author$project$TwoShips$main = A2(
	$MacCASOutreach$graphicsvg$GraphicSVG$EllieApp$gameApp,
	$author$project$TwoShips$Tick,
	{model: $author$project$TwoShips$init, title: 'Ellie Example', update: $author$project$TwoShips$update, view: $author$project$TwoShips$myShapes});
_Platform_export({'TwoShips':{'init':$author$project$TwoShips$main(
