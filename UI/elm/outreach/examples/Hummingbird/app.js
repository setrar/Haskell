...
var $author$project$Hummingbird$Tick = F2(
	function (a, b) {
		return {$: 'Tick', a: a, b: b};
	});
...
var $author$project$Hummingbird$init = {time: 0};
var $author$project$Hummingbird$update = F2(
	function (msg, model) {
		var t = msg.a;
		return {time: t};
	});
...
var $author$project$Hummingbird$beakColour = A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 208, 31, 81);
var $author$project$Hummingbird$bodyColour = A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 1, 123, 224);
...
var $author$project$Hummingbird$hummingbird = function (model) {
	var beat2 = F2(
		function (a, b) {
			return a + (((b - a) * 0.5) * ($elm$core$Basics$cos((20 * model.time) + 1) + 1));
		});
	var beat1 = F2(
		function (a, b) {
			return a + (((b - a) * 0.5) * ($elm$core$Basics$cos(20 * model.time) + 1));
		});
	return A2(
		$MacCASOutreach$graphicsvg$GraphicSVG$scale,
		5,
		$MacCASOutreach$graphicsvg$GraphicSVG$group(
			_List_fromArray(
				[
					A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$filled,
					$author$project$Hummingbird$bodyColour,
					A2(
					...
					A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$filled,
					$author$project$Hummingbird$beakColour,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$curve,
						_Utils_Tuple2(3, 4),
						_List_fromArray(
							[
								...
								$MacCASOutreach$graphicsvg$GraphicSVG$Pull,
								_Utils_Tuple2(4, 3.8),
								_Utils_Tuple2(2.9, 3.5))
							]))),
					A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(1.9, 3.7),
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$MacCASOutreach$graphicsvg$GraphicSVG$black,
						A2($MacCASOutreach$graphicsvg$GraphicSVG$oval, 0.75, 0.6))),
					A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$scale,
					0.3,
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$move,
						_Utils_Tuple2(1.95, 3.75),
						A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$filled,
...
var $author$project$Hummingbird$nectarColour = A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 224, 100, 224);
var $author$project$Hummingbird$petalColour = A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 224, 0, 224);
var $author$project$Hummingbird$view = function (model) {
	return A3(
		$MacCASOutreach$graphicsvg$GraphicSVG$Collage,
		500,
		500,
		_List_fromArray(
			[
				...
				$MacCASOutreach$graphicsvg$GraphicSVG$group(
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$filled,
							$author$project$Hummingbird$petalColour,
							A2($MacCASOutreach$graphicsvg$GraphicSVG$oval, 30, 15)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$filled,
							$author$project$Hummingbird$petalColour,
							A2($MacCASOutreach$graphicsvg$GraphicSVG$oval, 15, 30)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$filled,
							$author$project$Hummingbird$nectarColour,
				...
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(
						20 * $elm$core$Basics$sin(model.time),
						(10 * $elm$core$Basics$sin(model.time)) + (5 * $elm$core$Basics$sin(4 * model.time))),
					$author$project$Hummingbird$hummingbird(model))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(-30, 20),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(
						20 * $elm$core$Basics$sin(3 + model.time),
						(10 * $elm$core$Basics$sin(2 + model.time)) + (5 * $elm$core$Basics$sin(4 * model.time))),
					$author$project$Hummingbird$hummingbird(model))),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(-25, 20),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(
						20 * $elm$core$Basics$sin(5 + model.time),
						(10 * $elm$core$Basics$sin(10 + model.time)) + (5 * $elm$core$Basics$sin(4 * model.time))),
					$author$project$Hummingbird$hummingbird(model)))
			]));
};
var $author$project$Hummingbird$main = A2(
	$MacCASOutreach$graphicsvg$GraphicSVG$EllieApp$gameApp,
	$author$project$Hummingbird$Tick,
	{model: $author$project$Hummingbird$init, title: 'Ellie Example', update: $author$project$Hummingbird$update, view: $author$project$Hummingbird$view});
_Platform_export({'Hummingbird':{'init':$author$project$Hummingbird$main(
