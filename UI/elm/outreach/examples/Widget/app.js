...
var $author$project$Widget$WidgetOneMsg = function (a) {
	return {$: 'WidgetOneMsg', a: a};
};
var $author$project$Widget$WidgetTwoMsg = function (a) {
	return {$: 'WidgetTwoMsg', a: a};
};
...
var $author$project$Widget$initialModel = function () {
	var _v0 = A3($MacCASOutreach$graphicsvg$GraphicSVG$Widget$init, 90, 25, 'widget1');
	var wstate1 = _v0.a;
	var wcmd1 = _v0.b;
	var _v1 = A3($MacCASOutreach$graphicsvg$GraphicSVG$Widget$init, 50, 25, 'widget0');
	var wstate0 = _v1.a;
	var wcmd0 = _v1.b;
	return _Utils_Tuple2(
		{count: 0, widgetOneState: wstate0, widgetTwoState: wstate1, x: 0, y: 0},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Platform$Cmd$map, $author$project$Widget$WidgetOneMsg, wcmd0),
					A2($elm$core$Platform$Cmd$map, $author$project$Widget$WidgetTwoMsg, wcmd1)
				])));
}();
...
var $author$project$Widget$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'WidgetOneMsg':
				var wMsg = msg.a;
				var _v1 = A2($MacCASOutreach$graphicsvg$GraphicSVG$Widget$update, wMsg, model.widgetOneState);
				var newWState = _v1.a;
				var wCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Widget$WidgetOneMsg, wCmd));
			case 'WidgetTwoMsg':
				var wMsg = msg.a;
				var _v2 = A2($MacCASOutreach$graphicsvg$GraphicSVG$Widget$update, wMsg, model.widgetTwoState);
				var newWState = _v2.a;
				var wCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Widget$WidgetTwoMsg, wCmd));
			default:
				var _v3 = msg.a;
				var x = _v3.a;
				var y = _v3.b;
...
var $author$project$Widget$MoveTo = function (a) {
	return {$: 'MoveTo', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'width', '49.75%'),
				...
				_List_fromArray(
					[
						...
						model.widgetOneState,
						_List_fromArray(
							[
								A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$notifyMouseMoveAt,
								$author$project$Widget$MoveTo,
								A2(
									$MacCASOutreach$graphicsvg$GraphicSVG$filled,
									$MacCASOutreach$graphicsvg$GraphicSVG$gray,
									A2($MacCASOutreach$graphicsvg$GraphicSVG$rect, 50, 25))),
								A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$notifyMouseMoveAt,
								$author$project$Widget$MoveTo,
								A2(
								...
								A2(
									...
									A2(
										...
										$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
											$MacCASOutreach$graphicsvg$GraphicSVG$text('Widget #1 (50x25)')))))
							]))
					])),
				A2(
				$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								A2(
									...
									$MacCASOutreach$graphicsvg$GraphicSVG$square(2))),
								A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$move,
								_Utils_Tuple2(-25, 11),
								A2(
									...
									A2(
										...
										2,
										$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
											$MacCASOutreach$graphicsvg$GraphicSVG$text('Icon (50x25) [Not Interactive]')))))
							]))
					])),
				A2(
				$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								A2(
									...
									A2($MacCASOutreach$graphicsvg$GraphicSVG$rect, 90, 25))),
								A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$notifyMouseMoveAt,
								$author$project$Widget$MoveTo,
								A2(
								...
								A2(
									...
									A2(
										...
										2,
										$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
											$MacCASOutreach$graphicsvg$GraphicSVG$text('Widget #2 (90x25)')))))
							]))
					]))
			]));
};
var $author$project$Widget$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return $author$project$Widget$initialModel;
		},
		subscriptions: function (_v1) {
			return $elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						A2($elm$core$Platform$Sub$map, $author$project$Widget$WidgetOneMsg, $MacCASOutreach$graphicsvg$GraphicSVG$Widget$subscriptions),
						A2($elm$core$Platform$Sub$map, $author$project$Widget$WidgetTwoMsg, $MacCASOutreach$graphicsvg$GraphicSVG$Widget$subscriptions)
					]));
		},
		update: $author$project$Widget$update,
		view: $author$project$Widget$view
	});
_Platform_export({'Widget':{'init':$author$project$Widget$main(
